...
//     {
//         MockDbFactory.Reset();
//         var brands = (await _sut.GetBrandsAsync()).ToList();
//         // After reset, only Brand A is active
...
//         MockDb.Brands.Count.Should().Be(before + 1);
//     }
...
//         var updated = MockDb.Brands.FirstOrDefault(b => b.Id == 1);
//         updated.Should().NotBeNull();
//         updated!.Name.Should().Be("Brand A Updated");
//     }
...
//         var brands = MockDb.Brands.ToList();
//         result.Should().BeTrue();
//         brands.Should().NotContain(b => b.Id == 1);
//     }
